...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/victor/Projects/my-item-manager/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/victor/Projects/my-item-manager/public/storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'items.index','items.store',
'items.show','items.update','items.destroy','item-units.index','item-units.store',
'item-units.show','item-units.update','item-units.destroy',
'storage.local',);
